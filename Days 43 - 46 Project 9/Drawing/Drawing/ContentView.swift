...
//            .border(ImagePaint(image: Image("dog"),sourceRect: CGRect(x: 0, y: 0.25, width: 1, height: 0.5), scale: 0.1), width: 30)
        Capsule()
            .strokeBorder(ImagePaint(image: Image("dog"), scale: 0.1), lineWidth: 20)
