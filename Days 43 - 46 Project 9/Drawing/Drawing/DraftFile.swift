...
//    @State private var isShowLineWidth = true
//    
//    var body: some View {
//        NavigationView {
//            VStack {
//                Text("Distance: \(self.myLineWidth)")
//                //Spacer()
//                TriangleC()
//                    .stroke(Color.red, style: StrokeStyle(lineWidth: CGFloat(self.isShowLineWidth ? self.myLineWidth : 20.0), lineCap: .round, lineJoin: .round))
//                    .frame(width: 150, height: 350)
//                    .padding(.top, 20)
//                    .onTapGesture {
//                        withAnimation{
//                            self.myLineWidth = 10.0
//                            self.isShowLineWidth.toggle()
//                        }
//                }
//                
//                
//                
//                //            Slider(value: $myLineWidth, in: 1...30, step: 1)
//                //            .padding([.horizontal, .bottom])\Spa
//                
//                Spacer()
//            }
//        }
